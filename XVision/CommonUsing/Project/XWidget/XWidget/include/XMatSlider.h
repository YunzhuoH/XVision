...
#define XMAT_SLIDER_MARGIN 30

class XMatSliderPrivate;

class XWIDGET_EXPORT XMatSlider : public QAbstractSlider
{
    Q_OBJECT
...
public:
    explicit XMatSlider(QWidget *parent = 0);
    ~XMatSlider();
...
protected:
    ...
    const QScopedPointer<XMatSliderPrivate> d_ptr;

private:
    Q_DISABLE_COPY(XMatSlider)
    Q_DECLARE_PRIVATE(XMatSlider)
};
