...
XMatLineEditStateMachine::XMatLineEditStateMachine(XMatLineEdit *parent)
...
XMatLineEditStateMachine::~XMatLineEditStateMachine()
{
}

void XMatLineEditStateMachine::setLabel(XMatLineEditLabel *label)
{
    if (m_label) {
        delete m_label;
    }
...
void XMatLineEditStateMachine::setupProperties()
{
    if (m_label)
    {
...
XMatLineEditLabel::XMatLineEditLabel(XMatLineEdit *parent)
    : QWidget(parent),
      m_textField(parent),
      m_scale(1),
      m_posX(0),
      ...
      m_color(parent->labelColor())
{
    ...
    QFont font("Microsoft YaHei UI", parent->labelFontSize(), QFont::Medium);
    font.setLetterSpacing(QFont::PercentageSpacing, 102);
    setFont(font);
}

XMatLineEditLabel::~XMatLineEditLabel()
{
}
 ...
 *  \reimp
 */
void XMatLineEditLabel::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event)
