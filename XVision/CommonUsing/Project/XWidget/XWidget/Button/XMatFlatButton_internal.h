#ifndef XMATFLATBUTTON_INTERNAL_H
#define XMATFLATBUTTON_INTERNAL_H
...
class XMatFlatButtonStateMachine : public QStateMachine
{
    Q_OBJECT
...
public:
    explicit XMatFlatButtonStateMachine(XMatFlatButton *parent);
    ~XMatFlatButtonStateMachine();
...
private:
    Q_DISABLE_COPY(XMatFlatButtonStateMachine)
...
inline qreal XMatFlatButtonStateMachine::overlayOpacity() const
{
    return m_overlayOpacity;
}

inline qreal XMatFlatButtonStateMachine::checkedOverlayProgress() const
{
    return m_checkedOverlayProgress;
}

inline qreal XMatFlatButtonStateMachine::haloOpacity() const
{
    return m_haloOpacity;
}

inline qreal XMatFlatButtonStateMachine::haloSize() const
{
    return m_haloSize;
}

inline qreal XMatFlatButtonStateMachine::haloScaleFactor() const
{
    return m_haloScaleFactor;
}

#endif // XMATFLATBUTTON_INTERNAL_H
