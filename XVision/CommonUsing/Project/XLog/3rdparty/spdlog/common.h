...
enum level_enum : int
{
    ...
    event = SPDLOG_LEVEL_EVENT, //xie.y:新增日志类型
...
#define SPDLOG_LEVEL_NAME_EVENT spdlog::string_view_t("Event", 5)
...
#    define SPDLOG_LEVEL_NAMES                                                                                                             \
        {                                                                                                                                  \
            SPDLOG_LEVEL_NAME_TRACE, SPDLOG_LEVEL_NAME_DEBUG, SPDLOG_LEVEL_NAME_INFO, SPDLOG_LEVEL_NAME_EVENT,SPDLOG_LEVEL_NAME_WARNING, SPDLOG_LEVEL_NAME_ERROR,  \
