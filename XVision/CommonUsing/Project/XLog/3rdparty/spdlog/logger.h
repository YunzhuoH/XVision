...
public:
    ...
    template<typename... Args>
    void event(format_string_t<Args...> fmt, Args &&... args)
    {
        log(level::event, fmt, std::forward<Args>(args)...);
    }
    ...
    template<typename... Args>
    void event(wformat_string_t<Args...> fmt, Args &&... args)
    {
        log(level::event, fmt, std::forward<Args>(args)...);
    }
#endif
