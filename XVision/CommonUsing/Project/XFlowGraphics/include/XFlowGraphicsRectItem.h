...
public:
    XFlowGraphicsRectItem(QObject *parent = nullptr);
    XFlowGraphicsRectItem(QString type,QString id,QObject *parent = nullptr);
    ~XFlowGraphicsRectItem();
public:
 //*[属性接口]*
    ///矩形圆角大小
...
protected:
    const QScopedPointer<XFlowGraphicsRectItemPrivate> d_ptr;
private:
     Q_DECLARE_PRIVATE(XFlowGraphicsRectItem)

};

#endif // XFLOWGRAPHICSRECTITEM_H
