...
public:
    XFlowGraphicsEllipseItem(QObject *parent = nullptr);
    XFlowGraphicsEllipseItem(QString type,QString id,QObject *parent = nullptr);
    ~XFlowGraphicsEllipseItem();
    // XFlowGraphicsItem interface
public:
 //*[属性接口]*
    ///常规椭圆画笔
...
public:
    ...
    bool getFatherConnectData(XFlowGraphicsConnectLink *fatherLink, SConnectData &connData) override;
    bool getSonConnectData(XFlowGraphicsConnectLink *sonLink, SConnectData &connData) override;
...
protected:
    const QScopedPointer<XFlowGraphicsEllipseItemPrivate> d_ptr;
private:
     Q_DECLARE_PRIVATE(XFlowGraphicsEllipseItem)
};

#endif // XFLOWGRAPHICSELLIPSEITEM_H
